...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $_fold_ldq = $this->_quote_replace($this->left_delimiter);
        $_fold_rdq = $this->_quote_replace($this->right_delimiter);
        $source_content = preg_replace_callback($search, function ($matches) use ($_fold_ldq, $_fold_rdq) {
            return $_fold_ldq . 'php'
