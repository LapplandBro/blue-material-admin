...
function theme_num(num){
	if(num == "1")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/570388.jpg";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('bluegray').checked = 1;
		$id('color_theme_result').value = "bluegray";
		$id('theme_color_p').value = "";
		$id('bg_size').value = "100% 100%";
	}else if(num == "2")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/570390.jpg";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('cyan').checked = 1;
		$id('color_theme_result').value = "cyan";
		$id('theme_color_p').value = "";
		$id('bg_size').value = "100% 100%";
	}else if(num == "3")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/576752.jpg";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('cyan').checked = 1;
	...
	{
		$id('bg_scr').value = "themes/new_box/img/bg/620953.jpg";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('bluegray').checked = 1;
	...
	{
		$id('bg_scr').value = "themes/new_box/img/bg/653559.png";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('orange').checked = 1;
		$id('color_theme_result').value = "orange";
		$id('theme_color_p').value = "";
		$id('bg_size').value = "100% 100%";
	}else if(num == "6")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/653563.jpg";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('bluegray').checked = 1;
	...
	{
		$id('bg_scr').value = "themes/new_box/img/bg/665419.png";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('color_theme_result').value = "";
		$id('theme_color_p').value = "rgba(105,105,105,0.8)";
		//$id('theme_color_p').value = "#696969";
		$id('bg_size').value = "100% 100%";
	}else if(num == "8")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/715035.png";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('blue').checked = 1;
		$id('color_theme_result').value = "blue";
		$id('theme_color_p').value = "";
		$id('bg_size').value = "100% 100%";
	}else if(num == "9")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/725340.png";
		$id('bg_scr_rep').value = "no-repeat";
		$id('bg_scr_att').value = "fixed";
		$id('bg_pos').value = "center";
		$id('color_theme_result').value = "";
		$id('theme_color_p').value = "rgba(255,215,0,0.8)";
		//$id('theme_color_p').value = "#FFD700";
		$id('bg_size').value = "100% 100%";
	}else if(num == "10")
	{
		$id('bg_scr').value = "themes/new_box/img/bg/128-192.jpg";
		$id('bg_scr_rep').value = "repeat";
		$id('bg_scr_att').value = "";
		$id('bg_pos').value = "";
		$id('color_theme_result').value = "bluegray";
		$id('theme_color_p').value = "";
	...
	{
		$id('bg_scr').value = "themes/new_box/img/bg/128-129.jpg";
		$id('bg_scr_rep').value = "repeat";
		$id('bg_scr_att').value = "";
		$id('bg_pos').value = "";
		$id('color_theme_result').value = "";
		$id('theme_color_p').value = "rgba(0,0,0,0.8)";
		$id('bg_size').value = "";
	}
	var _tf = document.getElementById("theme_form"); if (_tf) _tf.submit();
}
