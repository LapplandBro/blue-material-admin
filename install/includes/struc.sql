...
CREATE TABLE IF NOT EXISTS `{prefix}_bans` (
  ...
  PRIMARY KEY  (`bid`),
  KEY `sid` (`sid`),
  KEY `{prefix}_bans__created` (`created`),
  KEY `{prefix}_bans__ip_lookup` (`ip`, `type`),
  KEY `{prefix}_bans__steam_lookup` (`authid`, `type`),
  KEY `{prefix}_bans__ip_steam_lookup` (`ip`, `authid`, `type`),
...
CREATE TABLE IF NOT EXISTS `{prefix}_srvgroups` (
  ...
  `maxbantime` INT NOT NULL DEFAULT '-1',
  `maxmutetime` INT NOT NULL DEFAULT '-1',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `{prefix}_menu` (
  ...
  `newtab` INT(4) NOT NULL DEFAULT '0',
  `priority` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


CREATE TABLE IF NOT EXISTS `{prefix}_vay4er` (
  `aid` int(6) NOT NULL auto_increment,
  `activ` int(6) NOT NULL,
  `value` varchar(64) NOT NULL,
  `days` int(11) NOT NULL,
  `group_web` varchar(128) NOT NULL,
  `group_srv` varchar(128) NOT NULL,
  `servers` varchar(128) NOT NULL default '',
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


CREATE TABLE IF NOT EXISTS `{prefix}_warns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_avatars` (
...
CREATE TABLE IF NOT EXISTS `{prefix}_vac` (
...
CREATE TABLE IF NOT EXISTS `{prefix}_cron` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
