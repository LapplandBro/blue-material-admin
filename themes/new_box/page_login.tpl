...
<div class="card">
                        <form class="form-horizontal" role="form">
                            <div class="card-header">
                                <h1>Авторизация <small>-{if $steam_allowed and $login_allowed}-Используйте ваши данные для входа в панель управления, либо авторизируйтесь через Steam.-{else}--{if $steam_allowed}-Авторизуйтесь через Steam.-{elseif $login_allowed}-Используйте ваши данные для входа в панель управления.-{/if}--{/if}-</small></h1>
                            </div>
								...
								<div id="login-content">
									...
									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10" id="loginSubmit">
											...
											-{sb_button text="Забыл пароль" onclick="sbGo('lostpassword')" icon="<i class='zmdi zmdi-help-outline'></i>" class="btn-icon-text bgm-orange"}-
										</div>
									</div>
									-{if $steam_allowed}-
									<div class="form-group">
