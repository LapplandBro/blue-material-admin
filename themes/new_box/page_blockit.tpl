...
function blockitBoot()
{
	resizeFrame();
	// Не через window.onload + body onload: body onload затирал LoadServers2 → вечный «ждём…».
	try { xajax_LoadServers2('-{$check}-', '-{$type}-', '-{$length}-'); } catch (e) {}
}
try {
...
<script type="text/javascript">blockitBoot();</script>
</body>
</html>
