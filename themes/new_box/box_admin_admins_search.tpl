	<div class="sea_open">
		<blockquote class="m-b-5 text-center bgm-orange c-white f-17" style="border-left: 30px solid transparent;border-right: 30px solid transparent;">
					...
					<tbody>
						...
						<tr>
							<td class="text-center" colspan="3">
								{sb_button text="Поиск" onclick="search_admins($exiperd_admins);" icon="<i class='zmdi zmdi-search'></i>" class="bgm-blue btn-icon-text" id="searchbtn" submit=false}
							</td>
						</tr>
