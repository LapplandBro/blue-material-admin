...
<div class="card banlist-panel admin-form">
	<div class="form-horizontal" role="form" id="add-group1">
		<div class="card-header">
			<h2>Новый бан
				<small>Ник, SteamID / IP, срок, причина и демо</small>
			</h2>
		</div>
		<div class="parsec-note parsec-note-muted m-b-0 admin-manage-hint">Демо: либо ссылка, либо файл — не оба сразу. Если загрузили файл, ссылка игнорируется.</div>
		<div class="card-body card-padding p-b-0" id="group.details">
			...
			<div class="form-group m-b-5">
				...
				<div class="col-sm-9 p-t-10">
					{sb_button text="Загрузить демо" onclick="childWindow=open('pages/admin.uploaddemo.php','upload','resizable=yes,scrollbars=yes,width=520,height=420');" class="bgm-orange" id="udemo" submit=false}
