	...
	<div class="card">
		...
		<div class="form-horizontal" role="form">
			<div class="card-body card-padding p-b-0">
				...
				<div class="form-group m-b-0">
					<label for="discord" class="col-sm-3 control-label text-right">{help_icon title="Discord" message="Введите ваш логин в Discord"} Discord</label>
					<div class="col-sm-9">
						<div class="fg-line">
							<input type="text" TABINDEX=1 class="form-control" id="discord" name="discord" placeholder="Введите данные" />
						</div>
					</div>
				</div>
				<div class="form-group m-b-0">
		...
		<div class="card-body card-padding text-center">
			{if $param == "0"}
				{sb_button text="Далее" icon="<i class='zmdi zmdi-check-all'></i>" class="bgm-blue btn-icon-text" id="pay_send" submit=true}
			{else}
