...
<div class="card banlist-panel admin-form">
	<div class="form-horizontal" role="form" id="add-group1">
		<div class="card-header">
			<h2>Мут / гаг
				<small>Ник, SteamID, тип, срок и причина</small>
			</h2>
		</div>
		...
		<div class="card-body card-padding text-center">
			{sb_button text="Добавить блокировку" onclick="ConvertSteamID_3to2('steam');ProcessBan();" icon="<i class='zmdi zmdi-shield-security'></i>" class="bgm-blue btn-icon-text" id="aban" submit=false}
				  &nbsp;
			{sb_button text="Назад" onclick="window.location.href='index.php?p=admin&c=comms'" icon="<i class='zmdi zmdi-undo'></i>" class="bgm-bluegray btn-icon-text" id="aback"}
		</div>
	</div>
</div>
