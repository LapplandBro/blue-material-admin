	...
	<div class="card banlist-panel admin-form">
		<div class="form-horizontal" role="form" id="add-group">
			<div class="card-header">
				<h2>Новый админ
					<small>Логин, SteamID, группы и срок</small>
				</h2>
			</div>
			<div class="card-body card-padding p-b-0">
				...
				<div class="form-group m-b-5">
					...
					<div class="col-sm-9">
						<div class="fg-line">
							<input type="text" TABINDEX=9 class="form-control" id="discord" name="discord" placeholder="Введите данные(Не обязательно)">
						</div>
