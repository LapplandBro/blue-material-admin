	...
	<div class="card banlist-panel admin-form" id="admin-page-content">
		...
		<div class="form-horizontal" role="form" id="add-group">
			...
			<div class="card-body card-padding text-center">
			    ...
			    &nbsp;
			    {sb_button text="Назад" onclick="window.location.href='index.php?p=admin&c=menu'" icon="<i class='zmdi zmdi-undo'></i>" class="bgm-bluegray btn-icon-text" id="back" submit=false}
			</div>
		</div>
		</div>
	</div>
