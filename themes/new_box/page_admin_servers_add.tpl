...
<div class="card banlist-panel admin-form">
	<div class="form-horizontal" role="form" id="add-group1">
		<div class="card-header">
			<h2>{$submit_text}
				<small>Адрес, RCON, мод и группы</small>
			</h2>
		</div>
		...
		<div class="card-body card-padding text-center">
			{if $edit_server}
				{sb_button text=$submit_text onclick="process_edit_server();" icon="<i class='zmdi zmdi-check-all'></i>" class="bgm-blue btn-icon-text" id="aserver" submit=true}
			{else}
