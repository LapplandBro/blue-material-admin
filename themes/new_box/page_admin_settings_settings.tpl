...
{*				<div class="form-group m-b-5">
			...
			<div class="card-body card-padding p-b-0">
				...
				<div class="form-group m-b-5">
					...
					<div class="col-sm-9">
						<textarea TABINDEX=6 cols="80" rows="20" id="dash_intro_text" name="dash_intro_text" class="html-editor">{$config_dash_text|escape}</textarea>
					</div>
				</div>
			...
			<div class="card-body card-padding text-center">
				...
				&nbsp;
				{sb_button text="Назад" onclick="sbGo('index.php?p=admin&c=settings')" icon="<i class='zmdi zmdi-undo'></i>" class="bgm-bluegray btn-icon-text" id="sback"}
			</div>
		</div>
	</div>
