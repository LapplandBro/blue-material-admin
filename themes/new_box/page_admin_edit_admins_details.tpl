...
<div class="form-horizontal" role="form" id="add-group">
			<div class="card-header">
				<h2>Детали админа
					<small>Логин, SteamID, почта и срок</small>
				</h2>
			</div>
			<div class="card-body card-padding p-b-0">
				...
				<div class="form-group m-b-5">
					<label for="discord" class="col-sm-3 control-label">{help_icon title="Discord" message="Связь с администратором через Discord."} Discord</label>
					<div class="col-sm-9">
						<div class="fg-line">
							<input type="text" TABINDEX=9 class="form-control" id="discord" name="discord" placeholder="Введите данные(Не обязательно)" value="{$discord|escape}">
						</div>
						<div id="discord.msg"></div>
					</div>
				</div>
				<div class="form-group m-b-5">
