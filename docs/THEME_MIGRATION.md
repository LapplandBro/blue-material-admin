...
1. **Лицензия** — каркас старой темы был унаследован; NC/ThemeForest-происхождение конфликтовало с «чистым GPL». Живая оболочка — Blue V2 (GPLv3). Идея Material-панели кредитуется в `NOTICE` (HLMod / Kruzya); этот форк живёт отдельно.
