				...
				<tr class="bg1">
					...
					<td>
						<?php
							...
							// SECURITY: escape stored server name before HTML output (stored XSS) - matches claninfo_general.php fix
							echo "<a href='hlstats.php?game=$game&amp;mode=servers&amp;server_id=" . (int)$favServerId . "'> " . htmlspecialchars($favServerName, ENT_COMPAT) . " </a>";
						?>
					</td>
				</tr>
				<tr class="bg2">
					...
					<td>
						<?php
							...
							// SECURITY: escape stored map name before HTML output (stored XSS) - matches claninfo_general.php fix
							echo "<a href=\"hlstats.php?game=$game&amp;mode=mapinfo&amp;map=" . urlencode($favMap) . "\"> " . htmlspecialchars($favMap, ENT_COMPAT) . " </a>";
						?>
					</td>
				</tr>
				<tr class="bg1">
