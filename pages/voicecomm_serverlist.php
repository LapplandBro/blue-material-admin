...
?>
        <tr class="bg1">
			...
			<td>
				<?php // SECURITY TODO: this plaintext-echoes the configured voice server password to every
				// visitor of this public stats page, including anonymous users. Left unchanged since some
				// admins intentionally publish the password so players can join; verify this is desired.
				echo htmlspecialchars($ts_server['password']); ?>
			</td>
...
<?php
		...
		?>  
			<tr class="bg1">
				...
				<td>
					<?php // SECURITY TODO: see note above - plaintext voice password shown to all visitors.
					echo htmlspecialchars($vent_server['password']); ?>
				</td>
				<td style="text-align:right;">
				...
				<td>
					<?php echo htmlspecialchars($vent_server['descr']); ?>
				</td>
			</tr>
<?php
			}
