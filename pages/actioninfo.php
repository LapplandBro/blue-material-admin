...
if ( !defined('IN_HLSTATS') )
{
	...
	// SECURITY TODO: this page (and the whole HLstats module) executes queries through
	// includes/class_db.php, which calls mysql_query()/mysql_real_escape_string()/mysql_fetch_array().
	// The mysql_* extension was removed in PHP 7 and calling these functions is a fatal error on PHP 7.1.
	// Fixing this requires porting includes/class_db.php to mysqli/PDO, which is outside this file's scope.
	// Action Details
