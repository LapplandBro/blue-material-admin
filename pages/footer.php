...
if (defined('DEVELOPER_MODE') && function_exists('sb_render_developer_debug_panel')) {
	sb_render_developer_debug_panel($userbank);
}
?>
<script>
...
window.addEvent('domready', function(){	
	...
	{?>
	if(document.getElementById('<?php echo $GLOBALS['enable']?>'))
	{
		if(settab != -1)
		{
			var settabEl = document.getElementById(settab);
			if(settabEl) settabEl.style.display = 'block';
		}
		else
		{
			document.getElementById('<?php echo $GLOBALS['enable']?>').style.display = 'block';
		}
	}
	<?php } ?>
	<?php 
