...
// Player Rankings
	// SECURITY: whitelist $game before it is interpolated into SQL below (defense in depth,
	// consistent with the same fix applied to the other HLstatsX pages that use $game).
...
<div class="block">
	...
	<?php
		...
		else
		{
			...
			if (!isset($minEvent))
			{
				// SECURITY/BUG: split() was removed in PHP 7 (fatal error); explode() is the direct equivalent here.
