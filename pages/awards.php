...
*/
	...
	// SECURITY: whitelist $game (shared/global, ultimately GET-derived) before using it unescaped in SQL/HTML below
	...
	if ($type == 'ajax' )
	{
		// SECURITY: original pattern '[^a-z]' had no regex delimiters and matched literally, allowing
		// path traversal characters through into the include() below (LFI). Use a proper delimited pattern.
