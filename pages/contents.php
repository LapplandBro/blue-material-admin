...
*/	
	...
	// SECURITY: whitelist $game (GET-derived) before it gets used unescaped in SQL/HTML across included pages
	if ($num_games == 1 || ($game = preg_replace('/[^A-Za-z0-9_\-]/', '', valid_request($_GET['game'], 0)))) {
		$redirect_to_game++;
		if ($num_games == 1) {
